...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-dark-bg flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="absolute top-[-10%] right-[-10%] w-[45%] h-[45%] bg-primary-900/30 blur-[130px] rounded-full pointer-events-none"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-[45%] h-[45%] bg-emerald-900/20 blur-[130px] rounded-full pointer-events-none"></div>
